...
<nav class="navbar navbar-expand-lg navbar-light fixed-top " style="background-color: #f9f9f9;">
  ...
  <div class=" text-center ">
        <div class="row">
          ...
          <div class="mb-5 chose">
          <a class="active" href="dashboard_Utilisateurs.php">Liste des Utilisateurs</a>
          </div>
          <div class="mb-5 chose">
          ...
          <div class="col-sm-9 form">
            ...
            <table class="table table-striped table-hover " >
                ...
                <tbody class="table-group-divider">
                    ...
                    <th  scope="row">1</th>
                    <td >Mark</td>
                    <td >Ottsxsxeedxsxo</td>
                    <td >
                    <button type="button" class="btn btn-primary mb-2 ms-2">Primary</button>
